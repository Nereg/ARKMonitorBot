...
{servers}
    ...
    async def info(self, ctx):
        ...
        embed.add_field(name='<:DB:739476980075986976> Servers in database',value=f'{makeRequest("SELECT Id FROM servers").__len__()}',inline=True)
        ...
        embed.add_field(name=':ping_pong: Ping',value=int(self.bot.latency * 1000),inline=True)
